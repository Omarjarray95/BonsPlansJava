...
public class AffichagePane1Controller implements Initializable 
{
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        for (Etablissement E : ESL1)
        {
            ...
            public void handle(ActionEvent e)
            {
                ...
                {
                    int Id = E.getId();
                    FXMLLoader FL = new FXMLLoader(getClass().getResource("EtablissementVBoxBack.fxml"));
                    Parent root = (Parent) FL.load();
                    EtablissementVBoxBackController EVC = FL.getController();
